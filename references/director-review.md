...
1. 中文结构化编写完成后 review-export / review-sync，同步画面、逐句说法与衔接。按 [三项分镜规范](three-part-storyboard.md) 核对正文仅呈现场景、人物运动、镜头运动；内部分析与三个主字段一致；镜号／时间码遵循目标格式，摄影机与人物的同步关系必须保留。正文不得混入“稍后验证”等制作待办；待办留在说明区。按目标系统规则转换，不擅自翻译原台词或添加未知情绪标签。
