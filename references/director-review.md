...
3. 先按 [导演创作与反向审阅](directing-practice.md) 遮住原通过理由，只读实际画面与台词做整场自评，再结合整段上下文和原文／已确认改编稿检查。先判断导演组体验是否成立：局部镜头逐次增加了什么信息，整体揭示是否解释空间，新增细节是否推动人物或气氛，删去重复镜头是否更好，以及内部任务边界有无强行收尾。人物表演另核对“正在经历什么 → 顺势的小动作 → 少量细微反应”：是否有具体刺激与任务依据，动作是否自然，细微反应是否适合本人物与处境、能否被当前镜头呈现且不过量（不限动作种类），是否保持真实反应时序；将表演判断写入 performance 证据。将其余判断写入现有 narrative、pacing、character 和 continuity 证据；不另造评分表代替创作。问题影响画面时先修改中文再同步；尚未解决时可记录 revise，不能把问题只藏进英文。
...
角色反应须有该角色实际获得信息的依据；用户手机里的消息不自动成为其他人的认知。重复等待、重复眼神确认需要作为相邻镜头整体审查。时长可解释不等于观看有效；“不笑、不后退”等限制不能单独替代人物策略与可见表演。持续固定或持续运动均不自动违规，检查实际观看变化而非比例。
